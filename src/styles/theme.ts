...
export const theme = css`
  :host {
    ...
    --default-primary-color: #e7a736;
    --focused-color: #cf983a;
    ...
    --divider-color: #e5f4e3;
    --footer-background-color: #4b5356;
    --footer-text-color: #ffffff;
    --twitter-color: #ffffff;
    --facebook-color: #ffffff;
    --border-light-color: #e5f4e3;
    --error-color: #e64a19;
    ...
    --box-shadow-primary-color: 0 3px 3px -2px rgba(231, 167, 54, 0.3),
      0 3px 4px 0 rgba(231, 167, 54, 0.3), 0 1px 8px 0 rgba(231, 167, 54, 0.3);
    --box-shadow-primary-color-hover: 0 1px 3px -2px rgba(231, 167, 54, 0.4),
      0 4px 5px 0 rgba(231, 167, 54, 0.4), 0 2px 9px 0 rgba(231, 167, 54, 0.4);
    --font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial,
      sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
    --max-container-width: 1280px;

    --primary-color-transparent: rgba(231, 167, 54, 0.1);
    --primary-color-light: rgba(231, 167, 54, 0.8);
